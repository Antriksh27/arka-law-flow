...
serve(async (req) => {
  ...
  try {
    ...
    console.log("Fetching contacts from Zoho Books...");
    ...
    console.log(`Successfully fetched ${contactsData.contacts?.length || 0} contacts`);
    ...
    console.error("Error in zoho-books-get-contacts function:", error);
    return new Response(
      JSON.stringify({ 
