...
serve(async (req) => {
  ...
  try {
    ...
    console.log("Fetching payments from Zoho Books...");
    
    const paymentsResponse = await fetch(
      `https://www.zohoapis.in/books/v3/customerpayments?organization_id=${organizationId}`,
      {
        headers: {
    ...
    console.error("Error in zoho-books-get-payments:", error);
    return new Response(
      JSON.stringify({ 
