-- PHASE 1: CRITICAL SECURITY FIXES (Fixed for audit_logs structure)
...
CREATE INDEX IF NOT EXISTS idx_audit_logs_details_risk_level ON public.audit_logs USING GIN ((details->>'risk_level'));
