-- Fix table references in upsert_legalkart_case_data RPC
-- Use correct table names: petitioners, respondents, ia_details (not prefixed with legalkart_)
...
DECLARE
  ...
  v_ia jsonb;
BEGIN
  -- Upsert main legalkart case record
  ...
  -- Insert petitioners (use correct table name)
  ...
  -- Insert respondents (use correct table name)
  ...
  -- Insert IA details (use correct table name)
