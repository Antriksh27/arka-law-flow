...
export const SECURITY_HEADERS = {
  ...
  'Content-Security-Policy': [
    ...
    "font-src 'self' data:",
    "connect-src 'self' https://hpcnipcbymruvsnqrmjx.supabase.co wss://hpcnipcbymruvsnqrmjx.supabase.co https://*.stream-io-api.com wss://*.stream-io-api.com https://api.knock.app wss://api.knock.app",
    "frame-src 'none'",
    "object-src 'none'",
    "base-uri 'self'",
    "form-action 'self'",
