...
export const APPOINTMENTS_LIST_COLUMNS =
  'id, title, appointment_date, appointment_time, duration_minutes, status, type, location, notes, client_id, case_id, lawyer_id, firm_id, daily_serial_number, created_at';
