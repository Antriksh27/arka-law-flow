...
export const APPOINTMENT_DETAILS_COLUMNS =
  'id, title, appointment_date, appointment_time, duration_minutes, status, type, location, notes, client_id, client_name, case_id, case_title, lawyer_id, assigned_user_name, contact_id, firm_id, created_at';
