...
export const MobileFilterBar: React.FC<MobileFilterBarProps> = ({
  ...
  return (
    <div className={cn("sticky top-[112px] z-20 bg-slate-50 overflow-x-auto scrollbar-hide", className)}>
          ...
          <button
            ...
            className={cn(
              ...
              activeFilter === filter.id
                ...
                : "bg-white border border-slate-200 text-foreground hover:bg-accent"
            )}
          >
            {filter.label}
