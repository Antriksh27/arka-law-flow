...
export const ClientTabs: React.FC<ClientTabsProps> = ({
  ...
  return <>
      ...
      <div className={isMobile ? "" : `bg-white border ${border.default} rounded-2xl shadow-sm m-8`}>
      <Tabs value={activeTab} onValueChange={onTabChange} className="w-full">
            ...
            <div className="flex items-start justify-between mb-4">
              <div className="flex items-center gap-4 flex-1">
                <Avatar className="w-16 h-16">
                  <AvatarFallback className={`${bg.muted} ${text.secondary} text-lg font-medium`}>
                ...
                <div className="flex-1">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className={`flex flex-wrap gap-4 text-sm ${text.secondary} items-center`}>
                      {client.organization && <div>
                          <span className="font-medium">Organization:</span> {client.organization}
                        </div>}
                    </div>
                    {(client.referred_by_name || client.source) && <div className={`flex flex-wrap gap-4 text-sm ${text.secondary}`}>
        ...
        {/* Tabs List */}
        <TabsList className={`w-full bg-white border-b ${border.default} h-auto p-0 ${isMobile ? 'sticky top-14 z-30' : ''}`}>
