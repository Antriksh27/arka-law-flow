        ...
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
            <div className="grid grid-cols-2 gap-3">
              <FormField control={form.control} name="full_name" rules={{
              ...
              <FormField control={form.control} name="role" rules={{
            ...
            field
                  ...
                  <FormControl>
                    <Textarea placeholder="Additional notes about this team member" rows={3} {...field} />
                  </FormControl>
                  <FormMessage />
                </FormItem>} />
