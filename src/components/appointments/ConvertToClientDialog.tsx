  ...
  const formContent = (
    <div className="flex flex-col h-full bg-slate-50">
      ...
      <ScrollArea className="flex-1">
        <div className="p-6">
          <form id="convert-to-client-form" onSubmit={handleSubmit(onSubmit)} className="space-y-6">
            {/* Client Information */}
            <div className="bg-white rounded-2xl p-4 shadow-sm border border-slate-100 space-y-4">
              <h3 className="text-lg font-medium text-slate-800 border-b border-slate-50 pb-2">Client Information</h3>
            ...
            {/* Case Information */}
            <div className="bg-white rounded-2xl p-4 shadow-sm border border-slate-100 space-y-4">
              <h3 className="text-lg font-medium text-slate-800 border-b border-slate-50 pb-2">Case Information (Optional)</h3>
            ...
            {/* Fees Information */}
            <div className="bg-white rounded-2xl p-4 shadow-sm border border-slate-100 space-y-4">
              <h3 className="text-lg font-medium text-slate-800 border-b border-slate-50 pb-2">Fees & Payment</h3>
      ...
      <div className="p-4 bg-white border-t border-slate-100 sticky bottom-0">
        <div className="flex gap-3">
          <Button 
            type="submit" 
            form="convert-to-client-form"
            disabled={isSubmitting}
            className="flex-1 h-12 rounded-full bg-slate-800 hover:bg-slate-700 text-white font-bold"
          >
