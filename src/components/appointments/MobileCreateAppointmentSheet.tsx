    ...
    <div className="flex flex-col h-full bg-slate-50">
      ...
      <div className="flex-1 overflow-y-auto pb-28 px-4">
        ...
        <div className="bg-white rounded-2xl overflow-hidden shadow-sm mb-4">
          <button
            ...
            className="w-full flex items-center gap-4 p-4 active:bg-slate-50 transition-colors border-b border-slate-100"
          >
          ...
          <div className="flex gap-2">
            {DURATION_OPTIONS.map(opt => (
              <button
                ...
                className={cn(
                  "flex-1 py-3 rounded-full text-sm font-semibold transition-all active:scale-95 border",
            ...
            {TYPE_OPTIONS.map(opt => {
              ...
              return (
                <button
                  ...
                  className={cn(
                    "flex-1 flex flex-col items-center gap-2.5 py-4 rounded-2xl transition-all active:scale-95 border-2",
                    isActive 
            ...
            <div className="p-4">
              <div className="flex items-center justify-between">
                ...
                <button
                  ...
                  className="flex items-center gap-1.5 text-sm font-semibold text-sky-500 active:opacity-70"
                >
              ...
              {additionalLawyers.length > 0 ? (
                    ...
                    return (
                      ...
                      >
                        ...
                        <button
                          ...
                          className="w-5 h-5 rounded-full bg-slate-200 flex items-center justify-center ml-1"
                        >
                ...
                <p className="text-sm text-slate-400 mt-2">No additional team members</p>
              )}
            </div>
          </div>
        </div>
          ...
          >
            ...
            <div className="flex-1 text-left min-w-0">
              ...
              {selectedCase?.case_number && (
                <p className="text-xs text-slate-400 truncate">{selectedCase.case_number}</p>
              )}
            </div>
        ...
        <div className="bg-white rounded-2xl overflow-hidden shadow-sm p-4">
          <Textarea
            ...
            className="min-h-[100px] rounded-xl resize-none border-0 bg-transparent p-0 focus-visible:ring-0 text-foreground placeholder:text-slate-400"
          />
        </div>
      </div>
      ...
      <div className="fixed bottom-0 left-0 right-0 p-4 bg-slate-50 safe-area-pb">
        <Button 
          ...
          className="w-full h-14 rounded-full text-base font-bold bg-slate-800 hover:bg-slate-900 text-white shadow-xl"
        >
