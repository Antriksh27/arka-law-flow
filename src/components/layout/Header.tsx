  ...
  return <header className="border-b border-[#E5E7EB] px-8 py-4 bg-slate-900">
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          <Button variant="ghost" size="icon" className="focus:ring-[#111827] relative text-slate-50 bg-amber-600 hover:bg-amber-500">
            <Bell className="w-5 h-5" />
            <span className="absolute -top-1 -right-1 w-3 h-3 bg-[#6B7280] border-2 border-white rounded-full"></span>
          </Button>
          <Button variant="ghost" size="icon" className="focus:ring-[#111827] text-slate-50 bg-amber-600 hover:bg-amber-500">
