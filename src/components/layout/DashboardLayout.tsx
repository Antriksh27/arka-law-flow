...
const DashboardLayout: React.FC<DashboardLayoutProps> = ({
  ...
  return (
    <SidebarProvider openSidebar={() => setSidebarOpen(true)}>
      <div className="flex h-dvh w-screen flex-row bg-background overflow-hidden">
        ...
        <div className="flex flex-1 flex-col w-full overflow-hidden">
          ...
          <main className={cn("flex-1 min-h-0 overflow-y-auto overscroll-none bg-background pb-6", isMobile && "pb-20")}>
            {children}
          </main>
