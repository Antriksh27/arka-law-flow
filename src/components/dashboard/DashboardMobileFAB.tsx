  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed bottom-[84px] right-4 z-50 w-14 h-14 rounded-full bg-slate-800/95 backdrop-blur-md shadow-2xl hover:shadow-blue-500/20 active:scale-90 transition-all duration-300 flex items-center justify-center sm:hidden border border-white/20"
      >
