  ...
  const formView = (
    <div className="flex flex-col h-full bg-slate-50">
      <MobileDialogHeader
        ...
        subtitle="Add files to your document library"
        onClose={handleClose}
      />
      ...
      {/* Footer Actions */}
      <div className="flex-shrink-0 px-6 py-4 border-t border-slate-100 bg-white sticky bottom-0">
        {showSuccessOptions ? <div className="space-y-3">
            ...
            <div className="flex justify-end gap-3">
              <Button type="button" variant="outline" onClick={handleAddMoreFiles} className="flex-1 rounded-full h-11">
                <Plus className="w-4 h-4 mr-2" />
                Add More
              </Button>
              <Button type="button" onClick={handleFinishUploading} className="flex-1 bg-slate-800 hover:bg-slate-700 text-white rounded-full h-11 shadow-lg font-medium">
                Done
              </Button>
            </div>
          </div> : <div className="flex justify-end gap-3">
            <Button type="submit" form="upload-document-form" disabled={selectedFiles.length === 0 || uploadMutation.isPending} className="flex-1 bg-slate-800 hover:bg-slate-700 text-white rounded-full h-11 shadow-md font-medium">
