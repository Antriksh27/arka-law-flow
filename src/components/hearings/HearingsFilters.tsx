  ...
  const { data: cases } = useQuery({
    ...
    queryFn: async () => {
      ...
      return (data || []).filter(case_item => 
        case_item.id && case_item.case_title && case_item.case_title.trim() !== ''
      );
    }
  });
  ...
  return (
    <div className="bg-white border border-gray-200 rounded-2xl p-6 space-y-4">
      <div className="flex flex-wrap gap-4">
        ...
        <div className="flex gap-2">
          <Popover>
            <PopoverTrigger asChild>
              <Button variant="outline" className="justify-start text-left bg-white border-gray-300 text-gray-900 hover:bg-gray-50">
        ...
        {/* Clear Filters */}
        <Button variant="outline" onClick={clearFilters} className="bg-white border-gray-300 text-gray-900 hover:bg-gray-50">
