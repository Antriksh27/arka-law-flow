    ...
    return (
      <MobilePageContainer>
        ...
        <Tabs value={activeTab} onValueChange={onTabChange} className="w-full">
          {/* Mobile Tabs */}
          <TabsList className="w-full bg-background border-b border-border h-auto p-0 sticky top-14 supports-[top:env(safe-area-inset-top)]:top-[calc(3.5rem+env(safe-area-inset-top))] z-30">
