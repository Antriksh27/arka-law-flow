  ...
  const formView = (
    <div className="flex flex-col h-full bg-slate-50">
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Input type="tel" inputMode="numeric" placeholder="+91 XXXXX XXXXX" {...field} className="rounded-xl h-11 bg-slate-50" />
                        </FormControl>
                      </FormItem>
                    )}
                  />
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Input placeholder="000000" maxLength={6} inputMode="numeric" {...field} className="rounded-xl h-11 bg-slate-50" />
                        </FormControl>
                      </FormItem>
                    )}
                  />
      ...
      <div className="p-4 bg-white border-t flex gap-3">
        <Button type="submit" form="add-contact-form" disabled={addContactMutation.isPending} className="flex-1 rounded-full h-11">
          {addContactMutation.isPending ? <Loader2 className="w-4 h-4 mr-2 animate-spin" /> : 'Add Contact'}
        </Button>
      </div>
    </div>
  );
