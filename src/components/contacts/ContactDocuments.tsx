...
import { UploadDocumentForContactDialog } from '../documents/UploadDocumentForContactDialog';
...
export const ContactDocuments: React.FC<ContactDocumentsProps> = ({ contactId }) => {
  ...
  if (isMobile) {
    return (
      <>
        ...
        <UploadDocumentForContactDialog 
        ...
        <CardContent>
          {documents.length === 0 ? (
            <div className="text-center py-12">
              ...
              <p className="text-gray-500 mb-4">Upload documents for this contact to get started.</p>
              <Button onClick={() => setUploadDialogOpen(true)}>
                <Plus className="w-4 h-4 mr-2" />
