...
import { ECourtsCaseSearch } from './ECourtsCaseSearch';
...
interface CaseECourtsIntegrationProps {
  caseId: string;
  cnrNumber?: string;
...
export const CaseECourtsIntegration: React.FC<CaseECourtsIntegrationProps> = ({
  caseId,
  cnrNumber,
    ...
    <div className="space-y-4">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Manage eCourts API integration settings. Case data is displayed in the Details tab.
          </CardDescription>
        </CardHeader>
        <CardContent>
          ...
          <div className="bg-white rounded-lg max-w-6xl w-full max-h-[90vh] overflow-auto">
            <div className="p-6">
              <div className="flex items-center justify-between mb-4">
                <h2 className="text-xl font-semibold">eCourts Case Search</h2>
                <Button
                  variant="outline"
