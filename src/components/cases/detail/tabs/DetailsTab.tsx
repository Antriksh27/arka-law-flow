          ...
          <CollapsibleContent>
            <CardContent>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {[{
                label: 'Filing Number',
                value: legalkartData?.filing_number || caseData?.filing_number
              }, {
                label: 'Filing Date',
                value: formatDate(legalkartData?.filing_date || caseData?.filing_date)
              }, {
                label: 'Registration Number',
                value: legalkartData?.registration_number || caseData?.registration_number
              }, {
                label: 'Registration Date',
                value: formatDate(legalkartData?.registration_date || caseData?.registration_date)
              }, {
                label: 'CNR Number',
              ...
              // Disposed case specific fields - show before Coram
              ...
              ] : []),
              {
                ...
                label: 'District',
                value: legalkartData?.district || caseData?.district
              }, {
                label: 'Court Name',
                value: caseData?.court_name
              }, {
                label: 'Category',
                value: legalkartData?.category || caseData?.category
              }, {
                label: 'Sub-Category',
