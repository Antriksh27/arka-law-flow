      ...
      <Dialog open={isAddDialogOpen} onOpenChange={setIsAddDialogOpen}>
        <DialogContent hideCloseButton className="p-0 gap-0 bg-muted">
          <div className="flex flex-col h-full">
            <MobileDialogHeader
              title="Add Contact"
              subtitle="Add a contact to this case"
            ...
            <div className="p-4 border-t border-border bg-background">
              <div className="flex gap-3">
                ...
                <Button 
                  ...
                  disabled={addContactMutation.isPending || !formData.name}
                  className="flex-1 h-12 rounded-xl"
                >
      ...
      {contacts && contacts.length > 0 ? (
        <div className="grid gap-4">
          {contacts.map((contact) => (
            <div key={contact.id} className="bg-background border border-border rounded-2xl p-4">
                ...
                <div className="flex items-center gap-3 flex-1">
                  ...
                  <div className="flex-1">
                    <div className="flex items-center gap-2 mb-2">
                      ...
                      {contact.role && (
                        <span className="text-xs bg-muted px-2 py-1 rounded-full">{contact.role}</span>
                      )}
                    </div>
