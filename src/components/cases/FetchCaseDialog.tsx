        ...
        <form onSubmit={handleSubmit(handleFetch)} className="space-y-4">
          ...
          {fetchMethod === 'cnr' ? (
            <div>
              ...
              />
              {errors.cnr_number && (
                <p className="text-sm text-red-600 mt-1">{errors.cnr_number.message}</p>
              )}
            </div>
          ) : (
            <>
              <div>
                ...
                />
                {errors.case_number && (
                  <p className="text-sm text-red-600 mt-1">{errors.case_number.message}</p>
                )}
              </div>
              ...
              <div>
                ...
                />
                {errors.court_code && (
                  <p className="text-sm text-red-600 mt-1">{errors.court_code.message}</p>
                )}
              </div>
